...
if (!window.supabase) {
    ...
    if (container) {
        container.innerHTML = `<p class="text-center text-red-500 font-bold py-20">Error interno del sistema (Librería faltante).</p>`;
    }
} else {
    // SUPABASE_URL y SUPABASE_ANON_KEY vienen de tu archivo js/config.js
